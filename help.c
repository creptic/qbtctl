...
void show_help()
{
    ...
    printf("  -gu, --get-up-limit  Get upload limit\n");
    printf("  -gd, --get-dl-limit  Get download limit\n");
    printf("  -gdp, --get-dl-path  Get download path\n");
    printf("  -gr, --get-ratio     Get ratio limit\n");
    printf("  -gs, --get-seedtime  Get seedtime\n");
    printf("  -gsl,--get-seedtime-limit Get seedtime limit\n");
    printf("  -gsd, --get-seqdl    Get Sequential download flag\n");
    printf("  -gat, --get-autotmm  Get Auto TMM flag\n");
    printf("  -gss,--get-superseed Get superseed flag\n");
    printf("  -gtr, --get-tracker  Get tracker URL\n");
    printf("  -gtl, --get-tracker-list  Get trackers as a CSV list\n");
    printf("  -gp, --get-private   Get private flag\n");
    printf("  -gst, --get-status   Get torrent status\n");
